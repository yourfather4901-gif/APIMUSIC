...
class UpdateStarGiftPrice(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["stargift", "resell_stars"]

    ID = 0x3baea4e1
    QUALNAME = "functions.payments.UpdateStarGiftPrice"

    def __init__(self, *, stargift: "raw.base.InputSavedStarGift", resell_stars: int) -> None:
        self.stargift = stargift  # InputSavedStarGift
        self.resell_stars = resell_stars  # long
    ...
    def read(b: BytesIO, *args: Any) -> "UpdateStarGiftPrice":
        ...
        resell_stars = Long.read(b)
        
        return UpdateStarGiftPrice(stargift=stargift, resell_stars=resell_stars)
