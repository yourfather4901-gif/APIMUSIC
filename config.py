...
OWNER_ID = int(getenv("OWNER_ID", 6181216007))
...
# Support
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/ECHOWAVESUPPORT")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+sG4MieHq17w1MDBl")
